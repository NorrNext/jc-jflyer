...
?>
<a href="#" class="reply-btn" title="<?php echo JText::_('BUTTON_REPLY_WITH_QUOTE'); ?>" onclick="jcomments.showReply(<?php echo $comment->id; ?>,1); return false;"></a>
<?php
						}
					}
					if ($this->getVar('button-quote') == 1) {
?>
<a href="#"class="quote-btn" title="<?php echo JText::_('BUTTON_QUOTE'); ?>" onclick="jcomments.quoteComment(<?php echo $comment->id; ?>); return false;"></a>
<?php
					}
